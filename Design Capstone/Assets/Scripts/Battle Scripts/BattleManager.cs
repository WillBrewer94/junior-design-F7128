        ...
        if(RecordSwipe() && CheckSwipe(touchStart, touchEnd, offset)) {
            ...
            if(dist <= 200.0) {
                ...
                if(hitStreak > 0 && hitStreak % 10 == 0) {
                    ...
                    critText.GetComponent<Text>().text = "CRIT";
                    critText.GetComponent<Text>().color = new Color(206, 30, 30);
                ...
                hitStreak = 0;
                critText.GetComponent<Text>().text = "MISS";
                critText.GetComponent<Text>().color = new Color(255, 255, 255);
                critText.GetComponent<Animator>().SetTrigger("Crit");
            }
        }
